...
--
-- Name: games fkopponent_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fkopponent_id FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
